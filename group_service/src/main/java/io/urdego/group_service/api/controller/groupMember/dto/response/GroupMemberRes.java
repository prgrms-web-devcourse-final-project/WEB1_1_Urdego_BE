...
public record GroupMemberRes(Long groupId, Long userId, GroupMemberRole memberRole) {
    public static GroupMemberRes from(GroupMember member) {
        return new GroupMemberRes(member.getGroupId(), member.getUserId(), member.getMemberRole());
    }
}
